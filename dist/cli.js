...
export async function run() {
    ...
    program
        ...
        const generator = new MCPSkillGenerator(options.mcpConfig, options.outputDir);
    ...
    program
        ...
        try {
            if (options.list) {
                ...
                const callData = JSON.parse(options.call);
                const result = await executor.callTool(callData.tool, callData.arguments ?? {});
